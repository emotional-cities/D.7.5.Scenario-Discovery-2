...
def fn_process_activities():
    ...
    # Calcular el numero de shopping trip that women do on average
...
with open('Y_train_1_'+ mode + '.pickle', 'rb') as handle:
...
with open('Prediction_test_PRIM_new_1_dim_' + mode + '.pickle', 'wb') as handle:
    pickle.dump(predictions, handle, protocol=pickle.HIGHEST_PROTOCOL)
#Save the list with the results
with open('X_final_PRIM_new_1_dim_' + mode + '.pickle', 'wb') as handle:
    pickle.dump(X_new_labeled, handle, protocol=pickle.HIGHEST_PROTOCOL)
#Save the list with the results
with open('Y_final_PRIM_new_1_dim_'+ mode + '.pickle', 'wb') as handle:
